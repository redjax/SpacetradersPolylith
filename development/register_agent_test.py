...
from spacetraders.registration import build_register_agent_request
from spacetraders import agent_api
...
if __name__ == "__main__":
    ...
    agent_api.register_new_agent(agent_symbol=agent_symbol)
